...
import CurrentAccountCategoryForm from "../CurrentAccountCategoryForm";
...
const CurrentAccountForm = ({ onSubmitSuccess = () => {}, initialFormValues }: FormProps) => {
  ...
  return (
    <>
      <Modal show={showCategoryModal} setShow={setshowCategoryModal} title="Yeni Kategori Oluştur">
        <CurrentAccountCategoryForm />
      </Modal>
